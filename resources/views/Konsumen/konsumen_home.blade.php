...
@section('content')
      <section class="content-header">
        <br/>
        <ol class="breadcrumb">
          <li><a href="{{ route('home_konsumen') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        </ol>
      </section>
            ...
            <div class="box box-widget">
              <div class="box-header with-border">
                ...
                <img class="img-circle img-bordered-sm" src="{{ asset('cic.png') }}" alt="User Image">
                  <span class="username"><a href="{{ route('home_konsumen') }}">Selamat Datang</a></span>
                  ...
                  <div class="col-md-4">
                    <div class="box box-success">
                      <div class="box-body box-profile">
                        ...
                        <a href="{{ route('form_layanan') }}" class="btn btn-success btn-block" ><i class="fa fa-shopping-cart"> <b>Pesan</b></i></a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="box box-success">
                      <div class="box-body box-profile">
                        ...
                        <a href="{{ route('form_barang') }}" class="btn btn-success btn-block"><i class="fa fa-shopping-cart"> <b>Pesan</b></i></a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-2">
