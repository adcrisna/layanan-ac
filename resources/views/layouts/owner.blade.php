...
<head>
  ...
  <header class="main-header">
    <a href="{{ route('home_owner') }}" class="logo">
      <span class="logo-mini"><b>Owner</b></span>
      <span class="logo-lg"><b>Azzam Teknik Jaya</b></span>
    </a>
    <nav class="navbar navbar-static-top">
      <a href="{{ route('home_owner') }}" class="sidebar-toggle" data-toggle="offcanvas" role="button">
